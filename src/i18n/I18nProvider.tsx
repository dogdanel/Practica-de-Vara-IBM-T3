...
/** Resolves a dot-separated key (e.g. `footer.brand.address`) in the dictionary. */
...
export default function I18nProvider({
  ...
  const t = useCallback<I18nContextValue['t']>(
    (key, params) => {
      const text = resolve(translations[locale], key) ?? resolve(translations[DEFAULT_LOCALE], key);
      if (text === undefined) {
